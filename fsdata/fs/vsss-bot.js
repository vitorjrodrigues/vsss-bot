...
myApp.controller("vsssBotController", function($scope) {
	...
	$scope.resetbtn = function() {
			...
			$scope.onSpeedChange();
			document.getElementById("LsliderR").value = 10;
			document.getElementById("LW").style.color = "black";
	...
	$scope.ahead  = function() {
		...
		$scope.onSpeedChange();
		document.getElementById("LsliderR").value = 14 + $scope.speed;
	...
	$scope.retreat   = function() {
		...
		$scope.onSpeedChange();
		document.getElementById("LsliderR").value = 6 - $scope.speed;
	...
	$scope.turnRight  = function() {
		...
		$scope.right_vel_rng = 14 + $scope.speed;
		$scope.onSpeedChange();
		document.getElementById("LsliderR").value = 8 - $scope.speed;
		document.getElementById("LW").style.color = "red";
		document.getElementById("RW").style.color = "green";
	};	
